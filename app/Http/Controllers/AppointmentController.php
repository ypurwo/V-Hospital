...
class AppointmentController extends Controller
{
    ...
    {
        $myappointment = Appointment::latest()->where('user_id', Auth::user()->id)->get();
    ...
    public function check(Request $request)
    {
        ...
        return view('admin.appointment.index1',compact('times','appointmentId','date'));
    }
    ...
    public function Testing(Request $request){
        $myappointment = Appointment::latest()->where('user_id', Auth::user()->id)->get();
        return view('admin.appointment.index1',compact('myappointment'));
    }
