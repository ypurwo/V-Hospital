        ...
        <h3>Your Appointment time list </h3>
            ...
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <th scope="col">View/Update/Create</th>
                </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{route('appointment.check')}}" method="post">@csrf
                                ...
                                <button type="submit" class="btn btn-primary"><i class="ik ik-eye"></i>View/Update</button>
                                <a class="btn btn-success" href="{{route('appointment.create')}}" role="button"><i class="ik ik-edit-2"></i>Create</a>
                            </form>
                        </td>
                    </tr>
