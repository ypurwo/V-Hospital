    ...
    <div class="row align-items-end">
        <div class="col-lg-8">
            <div class="page-header-title">
                ...
                <div class="d-inline">
                    <h5>Doctors</h5>
                    <span>Create Profile Doctor</span>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
                ...
                <form class="forms-sample" action="{{route('doctor.store')}}" method="post" enctype="multipart/form-data">@csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <select class="form-control @error('password') is-invalid @enderror" name="gender">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="text" name="phone_number" class="form-control @error('phone_number') is-invalid @enderror" placeholder="doctor Phone Number" value="{{old('phone_number')}}">
                            @error('phone_number')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('role_id') is-invalid @enderror" name="department">
                                    <option value="">please select department</option>
                                    @foreach(App\Models\Department::where('coderegis','=','RJ')->get() as $department)
